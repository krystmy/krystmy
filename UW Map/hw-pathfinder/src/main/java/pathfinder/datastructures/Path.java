...
public class Path<E> implements Iterable<Path<E>.Segment> {
    ...
    public Path extend(E newEnd, double segmentCost) {
        checkRep();
        //
     ...
     * support the optional {@link Iterator#remove()} operation and will throw an
     * {@link UnsupportedOperationException} if {@link Iterator#remove()} is called.
     */
    @Override
