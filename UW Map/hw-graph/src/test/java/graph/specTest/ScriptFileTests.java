...
import utils.LabelledParameterized;
import utils.LabelledParameterized.Labels;
...
/**
 * This class, along with a complete GraphTestDriver implementation, can be used to test the your
...
public class ScriptFileTests {
  ...
  public static void calculateTestFiles() {
    ...
    ScriptFileTests.testScriptNames = new LinkedList<>();
    ScriptFileTests.testScriptFiles = new LinkedList<>();
    try {
  ...
  private String runScriptFile() throws IOException {
    ...
    GraphTestDriver td = new GraphTestDriver(r, w);
    td.runTests();
